botaobrigadeiro.addEventListener('click',function(){

    if (quantidadebrigadeiro.style.display === 'block') {
...
botaobeijinho.addEventListener('click',function(){

    if (quantidadebeijinho.style.display === 'block') {
...
botaodoisamores.addEventListener('click',function(){

    if (quantidadedoisamores.style.display === 'block') {
...
botaobrigadeirodemorango.addEventListener('click',function(){

    if (quantidadebrigadeirodemorango.style.display === 'block') {
...
botaobrigadeirodeuva.addEventListener('click',function(){

    if (quantidadebrigadeirodeuva.style.display === 'block') {
...
botaobombom.addEventListener('click',function(){

    if (quantidadebombom.style.display === 'block') {
